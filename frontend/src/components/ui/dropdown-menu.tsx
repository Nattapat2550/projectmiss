...
function DropdownMenuItem({
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				"group/dropdown-menu-item focus:bg-accent focus:text-accent-foreground not-data- iant=destructive]:focus:**:text-accent-foreground data- iant=destructive]:text-destructive data- iant=destructive]:focus:bg-destructive/10 data- iant=destructive]:focus:text-destructive dark:data- iant=destructive]:focus:bg-destructive/20 data- iant=destructive]:*:[svg]:text-destructive relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className
			)}
			{...props}
		/>
